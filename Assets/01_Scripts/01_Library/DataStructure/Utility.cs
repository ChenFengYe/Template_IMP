...
namespace MyGeometry
{
    public class Utility
    {
        ...
        public static Mesh MeshCreateFromRectList(List<Quad> RectList)
        {
            Mesh mesh = new Mesh();
            ...
            {
                foreach (var point in RectList[i].CornerPoints3d)
                {
                    vertices.Add(point);
                }
        ...
        public static double MinDistance(List<Vector2> set1, List<Vector2> set2)
        {
            double mindis = double.MaxValue;
